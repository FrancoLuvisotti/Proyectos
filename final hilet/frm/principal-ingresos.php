...
<body>
    <div class="container">
        ...
        <div class="row justify-content-center pt-3 mt-5 m-1">
            ...
            <div class="col-md-6 col-sm-8 col-xl-4 col-lg-5 formulario">
                <br>
                <form method="POST" action="../acc/acc.agrega_ingreso.php">
                    <div class="form-group text-center">
                        <h2 class="text-light">INGRESOS</h2>
                    </div>
                    <div class="form-group">
                        <label for="ingreso">Descripcion</label>
                        <input type="text" class="form-control" name="ingreso" autocomplete="off">
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary btn-block btn-lg">Agregar ingreso</button>
                </form>
            </div>
        </div>
        <div class="col-4">&nbsp;</div>
    ...
    <?php
    $sql = "SELECT * FROM ingresos WHERE usuario_id=" . $_SESSION["usuario_id"];
                ...
                <tbody>
                    ...
                    while ($fila = @mysqli_fetch_array($res)) { ?>
                        <tr>
                            ...
                            <td>
                                <?php include "../modales/modal_borra_ingreso.php"; ?>
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal_borra_ingreso<?php echo $fila['ingreso_id']; ?>">
                                    <i class="bi bi-trash"></i>
                                </button>
                                &nbsp;
                                <!-- <a class="btn btn-success" href="frm.editaingreso.php?ingreso_id=<?php echo $fila['ingreso_id']; ?>">
                        <i class="bi bi-pencil-square"></i>
                      </a> -->
                                <?php include "../modales/modal_edita_ingreso.php"; ?>
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal_edita_ingreso<?php echo $fila['ingreso_id']; ?>">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                            </td>
                        </tr>
